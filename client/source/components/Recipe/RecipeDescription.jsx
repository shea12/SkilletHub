...
// <Col xs={6} md={6}>
  // <img style={{maxWidth: '500px', maxHeight: '500px'}} src={'http://steamykitchen.com/wp-content/uploads/2009/08/hainanese-chicken-83.jpg'} alt={'picture of food'}/>
// </Col>

// <h4 style={{display: 'inline'}}> yield {recipeDescription.servings.value } </h4> <h2 style={{display: 'inline'}}> / </h2> <h4 style={{display: 'inline'}}> cook time {'Unknown'} </h4> <h2 style={{display: 'inline'}}> / </h2> <h4 style={{display: 'inline'}}> skill level {recipeDescription.skillLevel.value || 'Unknown'} </h4> 
