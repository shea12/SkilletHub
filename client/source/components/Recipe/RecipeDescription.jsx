...
export default ({recipeDescription}) => {
  return (
      <div>
        ...
        <img style={{maxWidth: '250px', maxHeight: '250px'}} src={'bdj.jpg'} alt="http://sharing.kshb.com/sharekgtv/photo/2014/08/15/instant_ramen_noodles_1408131512923_7390899_ver1.0_640_480.jpg"/>
        <div> 
          <span> yield: {recipeDescription.servings.value || 'Unknown'} </span>
          <span> cook time: {'Unknown'} </span>
