...
export default ({recipeList, name, handleRecipeForkClick}) => {
  return (
    <div> 
      ...
      return (
        <Row key={`${name}${i}`} style={{margin: 5}}> 
          <Thumbnail src={recipe.picture.value} alt="200x200">
            ...
            <p>
              <Button bsStyle="success" onClick={handleRecipeForkClick.bind(this)} data-username={recipe.username} data-recipe={recipe.rootVersion} data-branch={recipe.branch} data-version={recipe._id}>Cook</Button>&nbsp;
