      ...
      <Grid>
        ...
        <Row>
          <Col xs={4} md={4}>
            ...
            <ExploreList name="newRecipes" recipeList={this.state.newRecipes} handleRecipeCookClick={this.props.handleRecipeCookClick} handleRecipeForkClick={this.props.handleRecipeForkClick}/>
          </Col>
          <Col xs={4} md={4}>
            <h4> The Unicorns </h4> 
            <p> The myths. The legends. The most popular recipes on Skillet Hub. </p> 
            <ExploreList name="popularRecipes" recipeList={this.state.popularRecipes} handleRecipeCookClick={this.props.handleRecipeCookClick} handleRecipeForkClick={this.props.handleRecipeForkClick}/>
          </Col>
          <Col xs={4} md={4}>
            <h4> The Hot List </h4> 
            <p> These recipes are the currently trending topics in Skillet Hub's community. </p> 
            <ExploreList name="trendingRecipes" recipeList={this.state.trendingRecipes} handleRecipeCookClick={this.props.handleRecipeCookClick} handleRecipeForkClick={this.props.handleRecipeForkClick}/>
          </Col>
        </Row> 
      </Grid> 
    )
