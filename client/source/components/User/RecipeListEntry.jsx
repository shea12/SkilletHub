...
export default ({recipe, handleUserClick, handleRecipeClick}) => {
  ...
  return (
        <Row height={50}> 
          <Col xs={6} md={6}> 
            <h2 id={recipe.rootRecipeId} onClick={handleRecipeClick.bind(this)}> {recipe.name || 'Master Recipe'} </h2> 
            <h5 id={recipe.rootRecipeId} onClick={handleRecipeClick.bind(this)}> recipe id: {recipe.rootRecipeId} </h5>
